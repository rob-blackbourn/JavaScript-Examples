...
module.exports = function (repository) {
    ...
    repository.add(new Converter("volume", "utensils", "CAN", "tsp", "teaspoon", litreConverter,
        function (value) {
        return value.mul(teaspoonScalar);
    }, function (value) {
        return value.div(teaspoonScalar);
    }));
    repository.add(new Converter("volume", "utensils", "CAN", "dstspn", "dessertspoon", litreConverter,
        function (value) {
        return value.mul(dessertspoonScalar);
    }, function (value) {
        return value.div(dessertspoonScalar);
    }));
    repository.add(new Converter("volume", "utensils", "CAN", "tbsp", "tablespoon", litreConverter,
        function (value) {
        return value.mul(tablespoonScalar);
    }, function (value) {
        return value.div(tablespoonScalar);
    }));
    repository.add(new Converter("volume", "utensils", "CAN", "cup", "cup", litreConverter,
        function (value) {
